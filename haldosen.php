...
<body>
    ...
    <div class="dashboard">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link active text-white" href="haldosen.php?id_dosen=<?php echo $data['id_dosen'] ?>"><i class="fas fa-user"></i> Profile</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active text-white" href="uploadmateri.php?id_dosen=<?php echo $data['id_dosen'] ?>"><i class="fas fa-book"></i> Materi Kuliah</a>
            </li>
            <li class="nav-item">
