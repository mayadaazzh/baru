...
<body>
    ...
    <div class="dashboard">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link active text-white" href="halmahasiswa.php?id_mahasiswa=<?php echo $data0['id_mahasiswa'] ?>"><i class="fas fa-user"></i> Profile</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link active text-white" href="tugasmahasiswa.php?id_mahasiswa=<?php echo $data0['id_mahasiswa'] ?>">"><i class="fas fa-clipboard"></i> Tugas Kuliah</a>
            </li>
