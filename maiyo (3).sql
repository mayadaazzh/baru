...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jun 2023 pada 14.23
...
(52, 1, 'materi pak muarifin cek', '454042657_List Anggota.pdf'),
(53, 2, 'materi bu fitri cek', '144422367_List Anggota.pdf');
...
(2, 24, 3, 'List Anggota.pdf', '2023-05-31 09:04:58', '100'),
(8, 10, 3, '$ak19_layanan_19-2021 (1).docx', '2023-05-29 22:25:52', '70'),
(10, 24, 6, 'List Anggota.pdf', '2023-05-31 09:07:54', '88'),
(19, 24, 20, 'revisian proposal 1.docx', '2023-06-05 19:03:29', '99'),
(20, 24, 21, 'List Anggota.pdf', '2023-06-05 19:03:49', '80');
...
(20, 1, 'tugas pak muarifin 1', 'kerjakan buat laporan praktikum nya yaaa', '2023-07-01 19:02:00', 0, '1389861436_List Anggota.pdf'),
(21, 2, 'tugas bu fitri cek', 'kerjakan di buat lapraknya ', '2023-06-05 19:05:00', 0, '1308468454_Nama Anggota Kelompok Webinar BUILD OWN SIMPLE REST API WITH LARAVEL.docx');
...
--
ALTER TABLE `materi`
  MODIFY `id_materi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `pengumpulan`
  MODIFY `id_pengumpulan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `tugas`
  ADD CONSTRAINT `tugas_ibfk_1` FOREIGN KEY (`id_dosen`) REFERENCES `dosen` (`id_dosen`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
